...
$(document).ready(function(){
	...
	$("#prender_uart").on("click", function(){
		turn_on_uart();
	}); 
...
function getPOTSensorValues()
{
	$.getJSON('/potSensor.json', function(data) {
		$("#POT_reading").text(data["vol"]);
	});
}
/**
...
function startPOTSensorInterval()
{
	setInterval(getPOTSensorValues, 5000);    
}
